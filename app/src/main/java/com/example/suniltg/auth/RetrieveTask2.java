 ...
 */
class RetrieveTask2 extends AsyncTask<String, String, String> {
    ...
    public RetrieveTask2(String type, String ttt, DatabaseReference databaseReference, String locale) {
        texttotranslate = ttt;
